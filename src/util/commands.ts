...
export namespace Commands {
    ...
    export const TOGGLE_RULE = "SonarLint.ToggleRule";
    ...
    export const SHOW_HELP_PANEL = "SonarLint.HelpAndFeedback";
    ...
    export const HELP_AND_FEEDBACK_LINK = "SonarLint.HelpAndFeedbackLinkClicked";
    ...
    export const SHOW_MCP_CONFIGURATIONS = "SonarLint.ShowMCPConfigurations";
    ...
    export const SHOW_CONNECTION_INFO = "SonarLint.ShowConnectionInfo";
    export const SHOW_ALL_CONNECTIONS = "SonarQube.ShowConnectionView";
    export const SHOW_ALL_INFO_FOR_CONNECTION = "SonarLint.ShowAllInfoForConnection";
    ...
    export const NAVIGATE_FINDING_LOCATION = "SonarLint.NavigateToFindingLocation";
