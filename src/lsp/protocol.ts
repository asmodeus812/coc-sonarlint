...
import * as protocol from "coc.nvim";
...
export namespace ExtendedClient {
    export namespace ShowRuleDescriptionNotification {
        export const type = new protocol.NotificationType<ShowStandaloneRuleDescriptionParams>("sonarlint/showRuleDescription");
    }

    export namespace SuggestBindingNotification {
        export const type = new protocol.NotificationType<SuggestBindingParams>("sonarlint/suggestBinding");
    }
    ...
    export namespace ListFilesInFolderRequest {
        export const type = new protocol.RequestType<FolderUriParams, ListFilesInScopeResponse, void>("sonarlint/listFilesInFolder");
    }
    ...
    export namespace GetJavaConfigRequest {
        export const type = new protocol.RequestType<string, GetJavaConfigResponse, void>("sonarlint/getJavaConfig");
    }

    export namespace ScmCheckRequest {
        export const type = new protocol.RequestType<string, boolean, void>("sonarlint/isIgnoredByScm");
    }

    export namespace ShowNotificationForFirstSecretsIssueNotification {
        export const type = new protocol.NotificationType("sonarlint/showNotificationForFirstSecretsIssue");
    }
    ...
    export namespace ShowSonarLintOutputNotification {
        export const type = new protocol.NotificationType("sonarlint/showSonarLintOutput");
    }

    export namespace OpenJavaHomeSettingsNotification {
        export const type = new protocol.NotificationType("sonarlint/openJavaHomeSettings");
    }

    export namespace OpenPathToNodeSettingsNotification {
        export const type = new protocol.NotificationType("sonarlint/openPathToNodeSettings");
    }

    export namespace BrowseToNotification {
        export const type = new protocol.NotificationType<string>("sonarlint/browseTo");
    }

    export namespace OpenConnectionSettingsNotification {
        export const type = new protocol.NotificationType<boolean>("sonarlint/openConnectionSettings");
    }
    ...
    export namespace ShowHotspotNotification {
        export const type = new protocol.NotificationType<RemoteHotspot>("sonarlint/showHotspot");
    }

    export namespace ShowIssueNotification {
        export const type = new protocol.NotificationType<Issue>("sonarlint/showIssue");
    }
    ...
    export namespace ShowIssueOrHotspotNotification {
        export const type = new protocol.NotificationType<Issue>("sonarlint/showIssueOrHotspot");
    }
    ...
    export namespace SetReferenceBranchNameForFolderNotification {
        export const type = new protocol.NotificationType<BranchNameForFolder>("sonarlint/setReferenceBranchNameForFolder");
    }

    export namespace NeedCompilationDatabaseRequest {
        export const type = new protocol.NotificationType("sonarlint/needCompilationDatabase");
    }
    ...
    export namespace ShouldAnalyseFileCheck {
        export const type = new protocol.RequestType<UriParams, ShouldAnalyseFileCheckResult, void>("sonarlint/shouldAnalyseFile");
    }
    ...
    export namespace FilterOutExcludedFiles {
        export const type = new protocol.RequestType<FileUris, FileUris, void>("sonarlint/filterOutExcludedFiles");
    }

    export namespace ReportConnectionCheckResult {
        export const type = new protocol.NotificationType<ConnectionCheckResult>("sonarlint/reportConnectionCheckResult");
    }

    export namespace CanShowMissingRequirementNotification {
        export const type = new protocol.RequestType<string, boolean, void>("sonarlint/canShowMissingRequirementsNotification");
    }

    export namespace DoNotShowMissingRequirementsMessageAgain {
        export const type = new protocol.NotificationType("sonarlint/doNotShowMissingRequirementsMessageAgain");
    }

    export namespace MaybeShowWiderLanguageSupportNotification {
        export const type = new protocol.NotificationType<string[]>("sonarlint/maybeShowWiderLanguageSupportNotification");
    }

    export namespace RemoveBindingsForDeletedConnections {
        export const type = new protocol.NotificationType<string[]>("sonarlint/removeBindingsForDeletedConnections");
    }

    export namespace StartProgressNotification {
        export const type = new protocol.NotificationType<StartProgressNotificationParams>("sonarlint/startProgressNotification");
    }
    ...
    export namespace EndProgressNotification {
        export const type = new protocol.NotificationType<EndProgressNotificationParams>("sonarlint/endProgressNotification");
    }
    ...
    export namespace ShowFixSuggestion {
        export const type = new protocol.NotificationType<ShowFixSuggestionParams>("sonarlint/showFixSuggestion");
    }

    export namespace GetTokenForServer {
        export const type = new protocol.RequestType<string, string, void>("sonarlint/getTokenForServer");
    }
    ...
    export namespace PublishHotspotsForFile {
        export const type = new protocol.NotificationType<PublishDiagnosticsParams>("sonarlint/publishSecurityHotspots");
    }

    export namespace PublishTaintVulnerabilitiesForFile {
        export const type = new protocol.NotificationType<PublishDiagnosticsParams>("sonarlint/publishTaintVulnerabilities");
    }

    export namespace PublishDependencyRisksForFolder {
        export const type = new protocol.NotificationType<PublishDiagnosticsParams>("sonarlint/publishDependencyRisks");
    }

    export namespace IsOpenInEditor {
        export const type = new protocol.RequestType<string, boolean, void>("sonarlint/isOpenInEditor");
    }
    ...
    export namespace SslCertificateConfirmation {
        export const type = new protocol.RequestType<SslCertificateConfirmationParams, boolean, void>(
    ...
    export namespace AssistCreatingConnection {
        export const type = new protocol.RequestType<AssistCreatingConnectionParams, AssistCreatingConnectionResponse, null>(
    ...
    export namespace AssistBinding {
        export const type = new protocol.RequestType<AssistBindingParams, AssistBindingResponse, null>("sonarlint/assistBinding");
    }
    ...
    export namespace ShowSoonUnsupportedVersionMessage {
        export const type = new protocol.NotificationType<ShowSoonUnsupportedVersionMessageParams>(
    ...
    export namespace SubmitNewCodeDefinition {
        export const type = new protocol.NotificationType<SubmitNewCodeDefinitionParams>("sonarlint/submitNewCodeDefinition");
    }
    ...
    export namespace SuggestConnection {
        export const type = new protocol.NotificationType<SuggestConnectionParams>("sonarlint/suggestConnection");
    }
    ...
    export namespace NotifyInvalidToken {
        export const type = new protocol.NotificationType<NotifyInvalidTokenParams>("sonarlint/notifyInvalidToken");
    }
    ...
    export namespace FlightRecorderStartedNotification {
        export const type = new protocol.NotificationType<FlightRecorderStartedParams>("sonarlint/flightRecorderStarted");
    }
    ...
    export namespace EmbeddedServerStartedNotification {
        export const type = new protocol.NotificationType<EmbeddedServerStartedParams>("sonarlint/embeddedServerStarted");
    }
}
...
export namespace ExtendedServer {
    ...
    export namespace CheckConnection {
        export const type = new protocol.RequestType<ConnectionCheckParams, ConnectionCheckResult, void>("sonarlint/checkConnection");
    }

    export namespace ShowHotspotRuleDescriptionNotification {
        export const type = new protocol.NotificationType<ShowHotspotRuleDescriptionNotificationParams>(
    ...
    export namespace GetHotspotDetails {
        export const type = new protocol.RequestType<ShowHotspotRuleDescriptionNotificationParams, ShowRuleDescriptionParams, null>(
    ...
    export namespace DidClasspathUpdateNotification {
        export const type = new protocol.NotificationType<DidClasspathUpdateParams>("sonarlint/didClasspathUpdate");
    }
    ...
    export namespace DidJavaServerModeChangeNotification {
        export const type = new protocol.NotificationType<DidJavaServerModeChangeParams>("sonarlint/didJavaServerModeChange");
    }
    ...
    export namespace DidLocalBranchNameChangeNotification {
        export const type = new protocol.NotificationType<DidLocalBranchNameChangeParams>("sonarlint/didLocalBranchNameChange");
    }
    ...
    export namespace ListAllRulesRequest {
        export const type = new protocol.RequestType0<RulesResponse, void>("sonarlint/listAllRules");
    }
    ...
    export namespace OnTokenUpdate {
        export const type = new protocol.NotificationType<TokenUpdateNotificationParams>("sonarlint/onTokenUpdate");
    }
    ...
    export namespace GetRemoteProjectsForConnection {
        export const type = new protocol.RequestType<GetRemoteProjectsForConnectionParams, Map<string, string>, void>(
    ...
    export namespace GetRemoteProjectNamesByProjectKeys {
        export const type = new protocol.RequestType<GetRemoteProjectNamesParams, { [key: string]: string }, null>(
    ...
    export namespace GenerateToken {
        export const type = new protocol.RequestType<GenerateTokenParams, GenerateTokenResponse, null>("sonarlint/generateToken");
    }
    ...
    export namespace ShowHotspotLocations {
        export const type = new protocol.RequestType<ShowHotspotLocationsParams, null, null>("sonarlint/showHotspotLocations");
    }
    ...
    export namespace OpenHotspotOnServer {
        export const type = new protocol.NotificationType<OpenHotspotParams>("sonarlint/openHotspotInBrowser");
    }
    ...
    export namespace OpenDependencyRiskInBrowser {
        export const type = new protocol.NotificationType<OpenDependencyRiskParams>("sonarlint/openDependencyRiskInBrowser");
    }

    export namespace DependencyRiskInvestigatedLocally {
        export const type = new protocol.NotificationType("sonarlint/dependencyRiskInvestigatedLocally");
    }
    ...
    export namespace HelpAndFeedbackLinkClicked {
        export const type = new protocol.NotificationType<HelpAndFeedbackLinkClickedNotificationParams>(
    ...
    export namespace LMToolCalled {
        export const type = new protocol.NotificationType<LMToolCalledNotificationParams>("sonarlint/lmToolCalled");
    }

    export interface ScanFolderForHotspotsParams {
        folderUri: string;
        documents: Array<protocol.TextDocumentItem>;
    }

    export namespace ScanFolderForHotspots {
        export const type = new protocol.NotificationType<ScanFolderForHotspotsParams>("sonarlint/scanFolderForHotspots");
    }

    export namespace ForgetFolderHotspots {
        export const type = new protocol.NotificationType("sonarlint/forgetFolderHotspots");
    }
    ...
    export namespace GetFilePatternsForAnalysis {
        export const type = new protocol.RequestType<UriParams, GetFilePatternsForAnalysisResponse, null>(
    ...
    export namespace GetSuggestedBinding {
        export const type = new protocol.RequestType<GetSuggestedBindingParams, GetSuggestedBindingResponse, null>(
    ...
    export namespace GetSuggestedConnections {
        export const type = new protocol.RequestType<GetSuggestedConnectionsParams, GetConnectionSuggestionsResponse, null>(
    ...
    export namespace GetSharedConnectedModeConfigFileContents {
        export const type = new protocol.RequestType<
    ...
    export namespace GetMCPServerConfiguration {
        export const type = new protocol.RequestType<GetMCPServerConfigurationParams, GetMCPServerConfigurationResponse, null>(
    ...
    export namespace GetMCPRulesFileContent {
        export const type = new protocol.RequestType<string, GetMCPRulesFileContentResponse, null>("sonarlint/getMCPRuleFileContent");
    }

    export namespace ReopenResolvedLocalIssues {
        export const type = new protocol.NotificationType<ReopenAllIssuesForFileParams>("sonarlint/reopenResolvedLocalIssues");
    }
    ...
    export namespace CheckIssueStatusChangePermitted {
        export const type = new protocol.RequestType<CheckIssueStatusChangePermittedParams, CheckIssueStatusChangePermittedResponse, null>(
            "sonarlint/checkIssueStatusChangePermitted"
        );
    }

    export namespace SetIssueStatus {
        export const type = new protocol.NotificationType<SetIssueStatusParams>("sonarlint/changeIssueStatus");
    }
    ...
    export namespace GetDependencyRiskTransitions {
        export const type = new protocol.RequestType<GetDependencyRiskTransitionsParams, GetDependencyRiskTransitionsResponse, null>(
            "sonarlint/getDependencyRiskTransitions"
        );
    }

    export namespace ChangeDependencyRiskStatus {
        export const type = new protocol.NotificationType<ChangeDependencyRiskStatusParams>("sonarlint/changeDependencyRiskStatus");
    }
    ...
    export namespace ShowHotspotDetails {
        export const type = new protocol.NotificationType<ShowHotspotDetailsParams>("sonarlint/showHotspotDetails");
    }
    ...
    export namespace GetAllowedHotspotStatuses {
        export const type = new protocol.RequestType<GetAllowedHotspotStatusesParams, GetAllowedHotspotStatusesResponse, null>(
    ...
    export namespace SetHotspotStatus {
        export const type = new protocol.NotificationType<SetHotspotStatusParams>("sonarlint/changeHotspotStatus");
    }
    ...
    export namespace AnalyseOpenFileIgnoringExcludes {
        export const type = new protocol.NotificationType<AnalyseOpenFileIgnoringExcludesParams>(
    ...
    export namespace AnalyzeVCSChangedFiles {
        export const type = new protocol.NotificationType<AnalyzeVCSChangedFilesParams>("sonarlint/analyzeVCSChangedFiles");
    }
    ...
    export namespace DidCreateBinding {
        export const type = new protocol.NotificationType<BindingCreationMode>("sonarlint/didCreateBinding");
    }
    ...
    export namespace CheckLocalDetectionSupported {
        export const type = new protocol.RequestType<UriParams, CheckLocalDetectionSupportedResponse, null>(
    ...
    export namespace ListUserOrganizations {
        export const type = new protocol.RequestType<ListUserOrganizationsParams, Organization[], void>("sonarlint/listUserOrganizations");
    }
    ...
    export namespace FixSuggestionResolved {
        export const type = new protocol.NotificationType<FixSuggestionResolvedParams>("sonarlint/fixSuggestionResolved");
    }

    export namespace FindingsFilteredNotification {
        export const type = new protocol.NotificationType<FindingsFilteredParams>("sonarlint/findingsFiltered");
    }
    ...
    export namespace DumpThreadsNotification {
        export const type = new protocol.NotificationType("sonarlint/dumpThreads");
    }
}
